...
if [ "$(uname)" = "Darwin" ]; then
    ...
    if ["$(uname -m)" = "arm64"]; then
        ...
        curl -L https://${URL_CLI}${CLI}/remoteit.aarch64-linux --output ./bin/rarm64/emoteit
        ...
        curl -L https://${URL_CLI}${CLI}/remoteit.arm-v7-linux --output ./bin/linux/remoteit
    ...
    #arm64 Windows
    # curl -L https://${URL_CLI}${CLI}/remoteit.aarch64-win.exe --output ./bin/x64/remoteit.exe
    # curl -L https://${URL_CONNECTD}${CONNECTD}/connectd.aarch64-win.exe --output ./bin/x64/connectd.exe
    # curl -L https://${URL_DEMUXER}${DEMUXER}/demuxer.aarch64-win.exe --output ./bin/x64/demuxer.exe
    # curl -L https://${URL_MUXER}${MUXER}/muxer.aarch64-win.exe --output ./bin/x64/muxer.exe
