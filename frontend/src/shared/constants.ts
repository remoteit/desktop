...
export const COGNITO_USER_POOL_ID = env.REACT_APP_COGNITO_USER_POOL_ID || 'us-west-2_GqrHk0ixX'
export const COGNITO_AUTH_DOMAIN = env.REACT_APP_COGNITO_AUTH_DOMAIN || 'remoteitdev.auth.us-west-2.amazoncognito.com'
