...
export const RemoteAI = props => {
  return (
    <svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        d="M10.85 10.8147V8.34985M0.850006 15.8147H2.85001M18.85 15.8147H20.85M13.85 14.8147V16.8147M7.85001 14.8147V16.8147M4.85001 10.8147H16.85C17.9546 10.8147 18.85 11.7101 18.85 12.8147V18.8147C18.85 19.9192 17.9546 20.8147 16.85 20.8147H4.85001C3.74544 20.8147 2.85001 19.9192 2.85001 18.8147V12.8147C2.85001 11.7101 3.74544 10.8147 4.85001 10.8147Z"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
