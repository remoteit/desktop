...
export function Logo({ white, ...props }: Props): JSX.Element {
  const css = useStyles()
  let light = css.light
  let dark = css.dark
  ...
  return (
    <Box width={160} {...props}>
      <svg viewBox="0 0 385.13 95.97" xmlns="http://www.w3.org/2000/svg">
        <path
          className={light}
...
const useStyles = makeStyles(({ palette }) => ({
  light: { fill: palette.primary.main /* '#1699d6'  */ },
  dark: { fill: palette.primary.main },
  white: { fill: 'white' /* palette.white.main */ },
}))
