...
export const GRAPHQL_API = env.VITE_GRAPHQL_API || 'https://api.remote.it/graphql/evan'
export const GRAPHQL_BETA_API = env.VITE_GRAPHQL_BETA_API || 'https://api.remote.it/graphql/evan'
