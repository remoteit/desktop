...
export const BT_UUIDS = {
  ...
  SSID: `0000a001${BT_BASE_UUID}`,
  PASSWORD: `0000a002${BT_BASE_UUID}`,
  CONNECT: `0000a003${BT_BASE_UUID}`,
  WIFI_LIST: `0000a004${BT_BASE_UUID}`,
  SCAN_WIFI: `0000a005${BT_BASE_UUID}`,
  CONNECT_STATUS: `0000a006${BT_BASE_UUID}`,
  REGISTRATION_CODE: `0000a010${BT_BASE_UUID}`,
}
