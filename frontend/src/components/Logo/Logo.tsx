...
export const Logo: React.FC<Props> = ({ color, ...props }) => {
  const css = useStyles({ color })

  return (
    <Box width={160} {...props}>
      <svg viewBox="0 0 385.13 95.97" xmlns="http://www.w3.org/2000/svg" className={css.color}>
        <path
...
const useStyles = makeStyles(({ palette }) => ({
  color: ({ color = 'primary' }: Props) => ({ fill: palette[color].main }),
}))
