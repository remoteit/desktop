...
export const LanSharePage: React.FC = () => {
  ...
  const selections: Selections[] = [
    ...
    { value: currentHost, name: 'Class-A Restriction', note: 'IP restricted to the local network' },
    { value: currentHost, name: 'Class-B Restriction', note: 'Narrowly IP restrict on the local network' },
    { value: currentHost, name: 'Class-C Restriction', note: 'Focused IP restriction on the local network' },
