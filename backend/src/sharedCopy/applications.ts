...
export class Application {
  ...
  launchDarwin: string = ` osascript -e 'tell application "Terminal" to activate' -e 'tell application "Terminal" to do script "clear" in window 1' -e 'tell application "Terminal" to do script " [commandTemplate] " in window 1' `
