...
if [ "$(uname)" = "Darwin" ]; then
    ...
    curl -fL https://${URL_MUXER}${MUXER}/muxer.aarch64-osx --output ./bin/arm64/muxer
    ...
    curl -fL https://${URL_MUXER}${MUXER}/muxer.aarch64-linux-gnu --output ./bin/arm64/muxer
    ...
    curl -fL https://${URL_MUXER}${MUXER}/muxer.aarch64-win.exe --output ./bin/arm64/muxer.exe   
